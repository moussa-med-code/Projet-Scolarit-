...
if(isset($_POST['Envoyer'])) {
    ...
    $sql = "SELECT * FROM etud WHERE (Matricule LIKE '%$chercher%' OR NomComplet LIKE '%$chercher%' OR Filiere LIKE '%$chercher%' OR Departements LIKE '%$chercher%') and Departements='Biologie'";
    ...
    $sql = "SELECT * FROM etud where Departements='Biologie'";
    $result = mysqli_query($con, $sql);
