...
if(isset($_POST['Envoyer'])) {
    ...
    $sql = "SELECT * FROM etud WHERE (Matricule LIKE '%$chercher%' OR NomComplet LIKE '%$chercher%' OR Filiere LIKE '%$chercher%' OR Departements LIKE '%$chercher%') and Departements='Chimie'";
    ...
    $sql = "SELECT * FROM etud where Departements='Chimie'";
    $result = mysqli_query($con, $sql);
