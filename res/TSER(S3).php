...
function reussite($notes) {
    ...
    <div class="container">
        ...
        <table>
            ...
            <tr>
                <td>Electrocinétique</td>
                <?php
                include "cnx.php";
                $mat=$_GET['mat'];
                $sql1=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Electrocinetique'";
                $sql2=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Electrotechnique'";
                $sql3=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Electromagnetisme avance'";
            ...
            <tr>
                <td>Electromagnétisme avancé</td>
            ...
            <tr>
                <td>Thermodynamique de l'ingénieur</td>
                <?php
                    $sql4=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Thermodynamique de lingenieur'";
                    $sql5=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Transferts thermiques'";
                    $sql6=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Mecanique des fluides'";
            ...
            <tr>
                <td>Mathématique de l'ingénieur</td>
                <?php
                    $sql7=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Mathematique de lingenieur'";
                    $sql8=" select Note_TP,Note_CC,Note_CF,credit from matiere ,note where matiere.id=note.id_matiere and matricule='$mat' and nom='Programmation MatLab, Excell'";
            ...
            <tr>
                <td>Programmation MatLab, Excell</td>
