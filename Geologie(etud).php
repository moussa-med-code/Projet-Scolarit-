...
if(isset($_POST['Envoyer'])) {
    ...
    $sql = "SELECT * FROM etud WHERE (Matricule LIKE '%$chercher%' OR NomComplet LIKE '%$chercher%' OR Filiere LIKE '%$chercher%' OR Departements LIKE '%$chercher%') and Departements='Geologie'";
    $result = mysqli_query($con, $sql);

    echo "<br>";
    echo "<br>";
    echo "<h3>Liste des Étudiants Inscrits en Géologie</h3>";
    ...
    $sql = "SELECT * FROM etud where Departements='Geologie'";
    $result = mysqli_query($con, $sql);

    echo "<br>";
    echo "<br>";
    echo "<h3>Liste des Étudiants Inscrits en Geologie</h3>";
