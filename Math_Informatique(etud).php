...
if(isset($_POST['Envoyer'])) {
    ...
    $sql = "SELECT * FROM etud WHERE (Matricule LIKE '%$chercher%' OR NomComplet LIKE '%$chercher%' OR Filiere LIKE '%$chercher%' OR Departements LIKE '%$chercher%') and Departements='Math/Informatique'";
    ...
    $sql = "SELECT * FROM etud where Departements='Math/Informatique'";
    $result = mysqli_query($con, $sql);
