...
if(isset($_POST['Envoyer'])) {
    ...
    $sql = "SELECT * FROM profs WHERE (telephone LIKE '%$chercher%' OR NomComplet LIKE '%$chercher%' OR matieres LIKE '%$chercher%' OR email LIKE '%$chercher%' OR Departements LIKE '%$chercher% ' OR date_embauche LIKE '%$chercher% ') and Departements='Physique'";
    ...
    $sql = "SELECT * FROM profs where Departements='Physique'";
    $result = mysqli_query($con, $sql);
